...
#define NUM_VERTEX_IN_CIRCLE 25 // one for all diameters define for now, better to do depending on diameter
#define NUM_STEPS_IN_RUPOR 56 // length in 10ths of mm (centimeter) ?
...
int main()
{
	...
	for (int i = 1; i < NUM_STEPS_IN_RUPOR; i++)
	{
		...
		else if (i > (NUM_STEPS_IN_RUPOR - SPECIAL_END)) // Y-advance no spiral rot
		{
			if (bEnd)
			{
